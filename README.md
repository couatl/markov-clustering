...
Данный алгоритм является быстрым и хорошо масштабируемым для больших данных. Его сложность составляет ![cmplx3](http://latex.codecogs.com/png.latex?O%28n*k*k%29), где n — количество узлов в графе, а k - максимальная степень вершины графа. 
