...
Функции работы с матрицами, использующие дополнительную память, выделяют не больше чем ![square](https://latex.codecogs.com/gif.latex?O%28n%5E%7B2%7D%29) дополнительной памяти (так как просто создают новую матрицу nxn).
